public class Main {
    public static void main(String[] args) {
        ...
        if (a) {
            ...
            System.out.println("a,b,c는 false, c가 false");
        } else {
        ...
        // 꼭 연산자 (&& = and)가 있어야함, 80 <= score < 90은 안됨
        // 중복 해당되도록 조건을 만들면 안됨
        ...
        // 제대로 설정하려면 독립적인 if문으로 만드는 것이 좋다
        if (num > 0) {
            System.out.println("num은 양수");
        }
        if (num % 2 == 0) {
        ...
        //if문 속에 if문  (3단계까지만 사용하는 게 좋음 > 길어지면 가독성이 떨어짐)
        if (true) {
            if (true) {
                if (true) {
